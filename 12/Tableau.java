...
public class Tableau {
    ...
    public void addValue(Integer value) {
        ...
        Cell c = smallest;
        Integer bump = addToRow(c, value);
        while (c.below != null && bump != null) {
            c = c.below;
            bump = addToRow(c, bump);
        }

        if (c.below == null && bump != null) {
            Cell newCell = new Cell(bump);
            c.below = newCell;
            newCell.above = c;
        }
    ...
    protected Integer addToRow(Cell curr, int value) {
        ...
        while (curr != null) {
            if (curr.value > value) {
                ...
                curr.right = newCell;
                newCell.left = curr;
                if (curr.below != null && curr.below.right != null) {
                    newCell.below = curr.below.right;
                    curr.below.right.above = newCell;
