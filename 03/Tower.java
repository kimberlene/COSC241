...
public class Tower {
    ...
    /** method height checks the height of tower.
     *  @return returns an int value for height of tower.
     */
    public int height() {
        Tower t1 = new Tower();
        if (rest == null) {
    ...
    /** method count counts the occurence of c in tower.
     *  @return returns an int value for no. of c's in tower.
     *  @param c is the char variable.
     */
